...
"""
This function retrieves all records from a specified database table. It has as parameter, the name of the table to query
Returns to list: All records from the table as a list of tuples
"""
def view_all(table):
...
"""
This function adds a new record to the database. It has as parameters query (str): SQL INSERT statement with placeholders
and values (tuple): Values to insert into the placeholders
"""
...
"""
This function updates existing records in the database. it has as parameter query (str): SQL UPDATE statement with placeholders
and values (tuple): New values for the record including ID
...
(e.g., donations, volunteers) without manual checks in the interface modules.
"""
